    ...
    > 
      ...
      <div className="h-[97%] pb-5 overflow-hidden">
        ...
        >
          <Link to={`/folders/all/snippets`}>
            <div className="py-2 w-full">
              <div className="flex">
                <img src={allSnippets} alt="All snippets icon" className="h-5 w-5 mr-2" />
        ...
        <Link to={`/folders/all/snippets`}>
            <div className="py-2 w-full">
              <div className="flex">
                <img src={favoriteIcon} alt="Favorite icon" className="h-5 w-5 mr-2" />
        ...
        <div className="flex justify-between items-center py-2">
          <div className="flex">
            <img src={collectionsIcon} alt="Collections Icon" className="h-5 w-5 mr-2" />
